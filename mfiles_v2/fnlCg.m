function x = fnlCg(x0,sampler,data)
%-----------------------------------------------------------------------
%-------------------------------------------------------------------------
x = x0;
...
% backtracking line-search
	...
	f0 = objective(x,dx, 0, sampler,data);
	t = t0;

        [f1]  =  objective(x,dx, t,sampler,data);
...
function [res] = objective(x,dx,t,sampler,data);

%DEFINE obj
res=obj(:)'*obj(:);

function grad = wGradient(x,sampler,data)
